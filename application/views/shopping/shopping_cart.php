...
if(empty($cart_check)) {
echo 'Your Cart is empty. Please add product';
} ?> </div>
...
<?php
// cancle image.
$path = "<img src='". base_url()."public/images/cartclose.png' width='30px' height='25px'>";
...
<input class ='fg-button teal' type="button" value="Place Order" onclick="window.location = '<?php echo base_url(); ?>shopping/billing_view'"></td>
</tr>
<?php endif; ?>
</table>
</div>
...
<?php echo "<span id='go_back'><a class='fg-button teal' href=" . base_url() . "shopping>Add More Product</a></span>"; ?>
</div>
</body>
</html>